...
public class CalendarSkinDAOImpl extends BaseDAO implements CalendarSkinDAO
{
	@Override
	public List<Skin> getSkins(User user)
	{
		...
		try
		{
			...
			statement = connection.prepareStatement(CalendarSQL.GET_SKINS);
	...
	{		
		...
		{
			connection = dao.getConnection();
			statement = connection.prepareStatement(CalendarSQL.GET_SKIN);
